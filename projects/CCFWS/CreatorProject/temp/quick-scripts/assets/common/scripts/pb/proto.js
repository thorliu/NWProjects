(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/common/scripts/pb/proto.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '66991s8zJpMsICCOeTA4TMg', 'proto', __filename);
// common/scripts/pb/proto.js
...
$root.TestMsgA = function () {
    ...
    TestMsgA.encode = function encode(message, writer) {
        ...
        if (message.E != null && message.hasOwnProperty("E")) writer.uint32( /* id 5, wireType 0 =*/40).uint32(message.E);
        return writer;
    };
    ...
    TestMsgA.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("A")) throw $util.ProtocolError("missing required 'A'", { instance: message });
        if (!message.hasOwnProperty("B")) throw $util.ProtocolError("missing required 'B'", { instance: message });
        if (!message.hasOwnProperty("C")) throw $util.ProtocolError("missing required 'C'", { instance: message });
        if (!message.hasOwnProperty("D")) throw $util.ProtocolError("missing required 'D'", { instance: message });
        return message;
    };
    ...
    TestMsgA.verify = function verify(message) {
        ...
        if (!$util.isString(message.A)) return "A: string expected";
        if (!$util.isInteger(message.B)) return "B: integer expected";
        if (typeof message.C !== "number") return "C: number expected";
        if (typeof message.D !== "boolean") return "D: boolean expected";
        if (message.E != null && message.hasOwnProperty("E")) if (!$util.isInteger(message.E)) return "E: integer expected";
        return null;
    };
    ...
    TestMsgA.fromObject = function fromObject(object) {
        if (object instanceof $root.TestMsgA) return object;
        var message = new $root.TestMsgA();
        if (object.A != null) message.A = String(object.A);
        if (object.B != null) message.B = object.B | 0;
        if (object.C != null) message.C = Number(object.C);
        if (object.D != null) message.D = Boolean(object.D);
        if (object.E != null) message.E = object.E >>> 0;
        return message;
    };
    ...
    TestMsgA.toObject = function toObject(message, options) {
        ...
        if (message.C != null && message.hasOwnProperty("C")) object.C = options.json && !isFinite(message.C) ? String(message.C) : message.C;
        if (message.D != null && message.hasOwnProperty("D")) object.D = message.D;
        if (message.E != null && message.hasOwnProperty("E")) object.E = message.E;
        return object;
    };
...
$root.TestMsgB = function () {
    ...
    TestMsgB.encode = function encode(message, writer) {
        ...
        if (message.msg != null && message.hasOwnProperty("msg")) $root.TestMsgA.encode(message.msg, writer.uint32( /* id 2, wireType 2 =*/18).fork()).ldelim();
        if (message.nums != null && message.nums.length) for (var i = 0; i < message.nums.length; ++i) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (!(message.nums && message.nums.length)) message.nums = [];
                    if ((tag & 7) === 2) {
                        var end2 = reader.uint32() + reader.pos;
                        while (reader.pos < end2) {
                            message.nums.push(reader.int32());
                        }
                    } else message.nums.push(reader.int32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    TestMsgB.verify = function verify(message) {
        ...
        if (message.nums != null && message.hasOwnProperty("nums")) {
            if (!Array.isArray(message.nums)) return "nums: array expected";
            for (var i = 0; i < message.nums.length; ++i) {
                if (!$util.isInteger(message.nums[i])) return "nums: integer[] expected";
            }
        }
        return null;
    };
    ...
    TestMsgB.fromObject = function fromObject(object) {
        if (object instanceof $root.TestMsgB) return object;
        var message = new $root.TestMsgB();
        if (object.id != null) message.id = object.id | 0;
        if (object.msg != null) {
            if (_typeof(object.msg) !== "object") throw TypeError(".TestMsgB.msg: object expected");
            message.msg = $root.TestMsgA.fromObject(object.msg);
        }
        if (object.nums) {
            if (!Array.isArray(object.nums)) throw TypeError(".TestMsgB.nums: array expected");
            message.nums = [];
    ...
    TestMsgB.toObject = function toObject(message, options) {
        if (!options) options = {};
        var object = {};
        if (options.arrays || options.defaults) object.nums = [];
        if (options.defaults) {
            object.id = 0;
            object.msg = null;
        }
        if (message.id != null && message.hasOwnProperty("id")) object.id = message.id;
        if (message.msg != null && message.hasOwnProperty("msg")) object.msg = $root.TestMsgA.toObject(message.msg, options);
