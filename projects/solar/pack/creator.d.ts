...
declare module cc {	
	...
	*/
	...
	export enum DebugMode {		
		...
		>0 为动画的重复次数。 
		*/
		playAnimation(animName : string, playTimes : number) : any;		
		/** !#en
		...
		*/
		addEventListener(eventType : any, listener : Function, target : any) : void;		
		/** !#en
		Remove the event listener for the DragonBones Event.
		!#zh
		移除 DragonBones 事件监听器。 
		*/
		removeEventListener(eventType : any, listener : Function, target : any) : void;		
		/** !#en
		Build the armature for specified name.
		!#zh
		构建指定名称的 armature 对象 
		*/
		buildArmature(armatureName : string) : any;		
		/** !#en
	...
	export enum WrapMode {		
		...
		*/
		...
		``` 
		*/
		getTileAt(pos : Vec2|number, y? : number) : any;		
		/** !#en
		...
		*/
		...
		!#zh 页面视图组件 */
		export class PageView extends Object {		
...
declare module sp {		
		...
		*/
		...
		返回一个 {{#crossLinkModule "sp.spine"}}sp.spine{{/crossLinkModule}}.TrackEntry 对象。 
		*/
		getCurrent(trackIndex : void) : any;		
		...
		*/
		...
		!#zh Spine 的 骨骼数据。 */
		export class SkeletonData extends Object {		
		...
		*/
		getRuntimeData(quiet? : boolean) : any;	
	}	
