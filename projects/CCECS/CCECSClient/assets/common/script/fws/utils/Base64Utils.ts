 ...
 * BASE64
 * @Author: 刘强 
 * @Date: 2018-08-02 11:27:02 
 * @Last Modified by:   刘强 
 * @Last Modified time: 2018-08-02 11:27:02 
 */
...
class Base64Utils {
  /** 通用的Base64编码函数
    ...
    */
  static base64encode (str: string, isUrl: string): string 
  {
       var out, i, len;
       var c1, c2, c3;
    ...
    * @returns {string}
    */
   static unicodeToUtf8(str: string): string 
   {
       var out, i, len, c;
    ...
    * @returns {string}
    */
   static utf8ToUnicode(str): string 
   {
       var out, i, len, c;
       var char2, char3;
